// ============================================================================
// mobile/critique.mjs — iOS entrypoint for the shared critique pass
// (core/critique.mjs). Owns the runs-dir default and the mobile rubric/prompts.
// Run: npm run critique:mobile [-- <runDir>]   (defaults to the latest run)
// ============================================================================
